...
.icon-offline {
    content: -webkit-image-set(url(//file.kaygb.top/static_css/konglong/100-error-offline.png) 1x, url(//file.kaygb.top/static_css/konglong/200-error-offline.png) 2x);
    position: relative;
}
.hidden {
    display: none;
...
<div id="t" class="offline">
    ...
    <div id="main-frame-error" class="interstitial-wrapper">
        ...
        <div id="offline-resources">
            <img id="offline-resources-1x" src="//file.kaygb.top/static_css/konglong/100-offline-sprite.png">
            <img id="offline-resources-2x" src="//file.kaygb.top/static_css/konglong/200-offline-sprite.png">
...
<script src="//file.kaygb.top/static_css/konglong/index.js"></script>
<script>
console.log('\n' + ' %c 404 恐龙游戏 by mck ' + ' %c https://eas1.cn/posts/119.html ' + '\n' + '\n', 'color: #fadfa3; background: #030307; padding:5px 0;', 'background: #fadfa3; padding:5px 0;');
